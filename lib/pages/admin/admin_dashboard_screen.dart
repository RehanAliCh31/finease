                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '$urgentReviews urgent reviews required',
                                  style: const TextStyle(
                                    color: Color(0xFFBA1A1A),
                                    fontSize: 12,
                                    fontFamily: 'Inter',
                      ...
                      _forumFlag(
                        context,
                        '"Has anyone tried the new offshore investment vehicle for long-term growth? Thinking about moving..."',
                        'Potential spam post',
                        Icons.flag_rounded,
                      ...
                      _forumFlag(
                        context,
                        '"Reported: Potential phishing link shared in \'Tax Planning\' thread. Please investigate immediately."',
                        'Security threat',
    ...
    return GestureDetector(
      onTap: () {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('$label action completed')));
      },
      child: Container(
  ...
  Widget _actionChip(BuildContext context, String label, IconData icon) {
    return ElevatedButton.icon(
      ...
      onPressed: () {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Executing: $label')));
      },
